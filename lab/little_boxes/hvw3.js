/* Third tryout of a completely generic layout */
/* Only testing weird combinations to make sure everything works */
// PROBLEMS ENCOUNTERED: Not enough space is reserved for all panels at start. currently only space for underneath panels is reserved when a new line is added.
    ...
    var me = {
        ...
        activate: function () {
            ...
            if (!active) {
                ...
                saveCursor();
                lastActive = active;
                rl.cursorTo(stdout, offsetThis[1], stdout.columns - footer.getMinHeight() + offsetThis[0] + row - 1);
            } else {
